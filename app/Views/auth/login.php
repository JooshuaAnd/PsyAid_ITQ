    ...
    <div class="col-12 col-sm-10 col-md-8 col-lg-5 col-xl-4">
        <div class="card card-custom p-4 bg-white shadow-sm">
            <div class="text-center mb-4">
                <div class="mb-3">
                    <img src="<?= base_url('images/Logo_PsyAid.png') ?>" alt="PsyAid Logo"
                        style="height: 75px; max-width: 250px; width: auto; object-fit: contain;">
                </div>
            ...
            <div class="bg-light p-3 rounded-3 border">
                <div class="fw-bold text-dark small mb-2"><i class="bi bi-info-circle me-1 text-primary"></i> Testing
                    Credentials:</div>
                <div class="d-grid gap-2">
                    <button type="button" onclick="fillCreds('admin@psyaid.id', 'password123')"
                        class="btn btn-outline-danger btn-sm text-start py-1 fs-7">
                    ...
                    <button type="button" onclick="fillCreds('relawan1@psyaid.id', 'password123')"
                        class="btn btn-outline-success btn-sm text-start py-1 fs-7">
                        <i class="bi bi-person-badge-fill me-1"></i> <strong>Relawan Posko 1:</strong>
                        relawan1@psyaid.id
                    </button>
                    <button type="button" onclick="fillCreds('psikolog1@psyaid.id', 'password123')"
                        class="btn btn-outline-primary btn-sm text-start py-1 fs-7">
